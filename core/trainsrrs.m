function [Var] = trainsrrs(X, Var, opt)
...
for iter = 1:opt.maxiter
    ...
    Var.Ptilde = updatePtilde_srrs(Var, opt);
    Var.Z = updateZ(Var, opt);
    Var.J = updateJ_srrs(Var);
    Var.E = updateE_srrs(Var, opt);
