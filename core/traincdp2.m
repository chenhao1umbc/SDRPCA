function [Var] = traincdp2(X, Var, opt)
...
if opt.plotcost
    ...
    if opt.calcost
        [or, al, ob1, ob2, ob3, ob4]= costfunc2(Var, opt, t1, t2);
    end 
end

for iter= 1: opt.maxiter    
    
    [Var.P, Var.L] = updatePL(Var, opt);   
